...
Multi Conv is a no-frills terminal utility for quickly converting image and video files without fussing with online tools. It wraps Pillow and MoviePy to batch those one-off format changes into a tiny menu-driven CLI.
